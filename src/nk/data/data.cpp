...
void BindDataPointer(phi::DataView& v, FieldId id, void* p) {
    switch (id) {
        ...
        case FieldId::VelocityTarget: v.velocity_target = static_cast<float*>(p); break;
        case FieldId::AccelerationTarget: v.acceleration_target = static_cast<float*>(p); break;
        case FieldId::ActuatorNoloadSpeed: v.actuator_noload_speed = static_cast<float*>(p); break;
        case FieldId::TaskNullspaceStiffness: v.task_nullspace_stiffness = static_cast<float*>(p); break;
        case FieldId::TaskNullspaceDamping: v.task_nullspace_damping = static_cast<float*>(p); break;
        case FieldId::DriveCommand: v.drive_command = static_cast<float*>(p); break;
        case FieldId::DriveDissipation: v.drive_dissipation = static_cast<float*>(p); break;
        case FieldId::DriveLower: v.drive_lower = static_cast<float*>(p); break;
        case FieldId::DriveUpper: v.drive_upper = static_cast<float*>(p); break;
        case FieldId::ControlMass: v.control_mass = static_cast<float*>(p); break;
        case FieldId::ControlFactor: v.control_factor = static_cast<float*>(p); break;
        case FieldId::ControlJacobian: v.control_jacobian = static_cast<float*>(p); break;
        case FieldId::ControlResponse: v.control_response = static_cast<float*>(p); break;
        case FieldId::ControlTaskMap: v.control_task_map = static_cast<float*>(p); break;
        ...
        case FieldId::GridInvMass:         v.grid_inv_mass = static_cast<float*>(p); break;
        case FieldId::CcGridFirst:         v.cc_grid_first = static_cast<uint32_t*>(p); break;
        case FieldId::GridContactCount:    v.grid_contact_count = static_cast<uint64_t*>(p); break;
        case FieldId::GridContactOffset:   v.grid_contact_offset = static_cast<uint64_t*>(p); break;
        case FieldId::UcontactLaw:         v.ucontact_law = static_cast<uint32_t*>(p); break;
        case FieldId::UcontactFriction:    v.ucontact_friction = static_cast<float*>(p); break;
        case FieldId::GridContactAttempted: v.grid_contact_attempted = static_cast<uint64_t*>(p); break;
        case FieldId::GridContactRetained: v.grid_contact_retained = static_cast<uint32_t*>(p); break;
        case FieldId::GridContactPeak:     v.grid_contact_peak = static_cast<uint64_t*>(p); break;
        case FieldId::GridContactOverflow: v.grid_contact_overflow = static_cast<uint64_t*>(p); break;
        case FieldId::MpmBoundaryImpulse:  v.mpm_boundary_impulse = static_cast<math::Vec3*>(p); break;
        case FieldId::MpmBoundaryMoment:   v.mpm_boundary_moment = static_cast<math::Vec3*>(p); break;
        case FieldId::StepMpmBoundaryImpulse: v.step_mpm_boundary_impulse = static_cast<math::Vec3*>(p); break;
        case FieldId::StepMpmBoundaryMoment: v.step_mpm_boundary_moment = static_cast<math::Vec3*>(p); break;
