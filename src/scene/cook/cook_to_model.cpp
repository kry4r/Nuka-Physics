...
// Reserve particle rows above the rigid budget, excluding grid-owned particles.
// Rigid slots retain the full manifold footprint; particle slots contain one point.
