// ---------------------------------------------------------------------------
// CUDA imported-scene demo timing coverage
// ---------------------------------------------------------------------------
...
void RunCudaSceneDemoTiming(const char* input_path, const char* artifact_name) {
...
TEST(CudaSceneDemoTiming, ImportedMjcfSceneCudaSimulationRenderUnderOneSecond) {
    RunCudaSceneDemoTiming("examples/scenes/complete_robot.xml",
                           "nuka_cuda_scene_demo_mjcf_perf.ppm");
}

TEST(CudaSceneDemoTiming, ImportedUsdSceneCudaSimulationRenderUnderOneSecond) {
    RunCudaSceneDemoTiming("examples/scenes/complete_robot.usda",
                           "nuka_cuda_scene_demo_usd_perf.ppm");
}
