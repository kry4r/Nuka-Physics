# Nuka Physics Individual Contributor License Agreement ("Agreement")

> This Individual Contributor License Agreement (ICLA) is a faithful adaptation
> of the Apache Software Foundation Individual Contributor License Agreement
> (ICLA v2.0). The substantive terms (the grants, representations, and
> disclaimers) follow the Apache ICLA; only the project name and the signing
> mechanism have been customized for the Nuka Physics project.

Thank you for your interest in **Nuka Physics** (the "Project"), maintained by
The Nuka Physics Authors (the "Project Owner"). In order to clarify the
intellectual property license granted with Contributions from any person or
entity, the Project Owner must have a Contributor License Agreement ("CLA") on
...
herein to the Project Owner and recipients of software distributed by the
Project Owner, You reserve all right, title, and interest in and to Your
Contributions.

## 1. Definitions

"You" (or "Your") shall mean the copyright owner or legal entity authorized by
the copyright owner that is making this Agreement with the Project Owner. For
...
communication sent to the Project Owner or its representatives, including but not
limited to communication on electronic mailing lists, source code control
systems, and issue tracking systems that are managed by, or on behalf of, the
Project Owner for the purpose of discussing and improving the Work, but
...
submit it to the Project Owner separately from any Contribution, identifying the
complete details of its source and of any license or other restriction
(including, but not limited to, related patents, trademarks, and license
agreements) of which You are personally aware, and conspicuously marking the
work as "Submitted on behalf of a third-party: [named here]".

## 7. Notice of Inaccuracy
...
Signing of this Agreement is handled automatically by the **CLA-assistant bot**
on each pull request. When You open a pull request, the bot will check whether
You have signed this Agreement. If You have not, the bot will comment on the
pull request with instructions; You sign by posting the confirmation comment
requested by the bot. Your signature and the associated metadata are recorded so
that the bot does not need to ask again for subsequent contributions.

See [CONTRIBUTING.md](CONTRIBUTING.md) for the full contribution workflow,
including the CLA-signing requirement. The pull request cannot be merged until
