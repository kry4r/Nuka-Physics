...
| CudaBatchJointDriveTiming/BatchedJointDriveSolveUnderOneSecond | `tests/perf/test_cuda_batch_joint_drive_timing.cpp` | 60 CUDA batched integration/joint projection/velocity-drive passes over 128 two-body environments using the instance-parallel joint/drive fast path | Wall time | < 1000 ms |
