...
| CudaParticleCouplingTiming/DeviceWorldMultiSlotDiagnosticsUnderOneSecond | `tests/perf/test_cuda_particle_coupling_timing.cpp` | 60 CUDA cooked two-box corner coupling passes over 2048 particles, validating multiple active cache slots per particle plus force/torque diagnostics | Wall time | < 1000 ms |
