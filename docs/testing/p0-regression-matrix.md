...
| CudaParticleCouplingTiming/DeviceWorldRigidImpulseCouplingUnderOneSecond | `tests/perf/test_cuda_particle_coupling_timing.cpp` | 60 CUDA coupling passes over 4096 particles against a cooked dynamic `DeviceWorld` sphere with rigid impulse feedback | Wall time | < 1000 ms |
