...
| 当前 | 完整多体/多介质耦合分析与优化 | 按 [共享几何/owner 细化 spec](../plans/2026-09-10-coupling-surface-owner-detailed-spec-zh.md) 开始首批；之后覆盖多个有限质量端点、刚体/机器人子步反作用及 MPM↔XPBD 交换，以守恒、界面残差和步长收敛判断 |
