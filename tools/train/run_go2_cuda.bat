...
build-win-editor\tests\nuka_go2_skill_video_cuda.exe --bin C:\Softwares\code\Nuka-Physics\out\go2_hs_visual_test.bin --out-dir C:\Softwares\code\Nuka-Physics\out\go2_cuda_test --frames 1 --samples 2
