...
build-win-editor\tests\nuka_go2_skill_video_cuda.exe --bin C:\Softwares\code\Nuka-Physics\out\go2_bf_cuda.bin --out-dir C:\Softwares\code\Nuka-Physics\out\go2_bf_cuda_frames --frames 100 --stride 1 --samples 2
